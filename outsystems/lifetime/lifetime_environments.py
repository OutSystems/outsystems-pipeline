...
def get_environment_url(artifact_dir :str, endpoint :str, auth_token :str, environment_name :str):
  return _find_environment_url(artifact_dir, endpoint, auth_token, environment_name)
...
def _get_environment_info(artifact_dir :str, api_url :str, auth_token :str, **kwargs):
  if "env_name" in kwargs:
    env_key = _find_environment_key(artifact_dir, api_url, auth_token, kwargs["env_name"])
    env_name = kwargs["env_name"]
  elif "env_key" in kwargs:  
    env_key = kwargs["env_key"]
    env_name = _find_environment_name(artifact_dir, api_url, auth_token, kwargs["env_key"])
  else:
