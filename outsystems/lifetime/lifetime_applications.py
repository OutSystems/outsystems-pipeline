...
def _get_application_info(artifact_dir :str, api_url :str, auth_token :str, **kwargs):
  if "app_name" in kwargs:
    app_key = _find_application_key(artifact_dir, api_url, auth_token, kwargs["app_name"])
    app_name = kwargs["app_name"]
  elif "app_key" in kwargs:  
    app_key = kwargs["app_key"]
    app_name = _find_application_name(artifact_dir, api_url, auth_token, kwargs["app_key"])
  else:
...
def _find_application_key(artifact_dir :str, api_url :str, auth_token :str, application_name: str):
  ...
  try:
    ...
    applications = get_applications(artifact_dir, api_url, auth_token, False)
