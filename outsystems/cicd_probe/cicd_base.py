...
# Custom Modules
# Functions
from outsystems.configurations.pipeline_configurations import get_conf_value
# Exceptions
...
def send_probe_get_request(probe_api: str, probe_endpoint: str, url_params: str):
    ...
    # Send the request
    response = requests.get(request_string, params=url_params, verify=bool(get_conf_value("SSL_CERT_VERIFY")))
